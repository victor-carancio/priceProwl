...
-- AddForeignKey
ALTER TABLE "InfoGame" ADD CONSTRAINT "InfoGame_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AlternativeName" ADD CONSTRAINT "AlternativeName_info_game_id_fkey" FOREIGN KEY ("info_game_id") REFERENCES "InfoGame"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
